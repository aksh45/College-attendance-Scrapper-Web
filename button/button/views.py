...
def output(request):
    ...
    with requests.Session() as s:
        ...
        attendance = s.get(attendance_link)
        ...
        attendance_all = s.get(allattendance_link)
